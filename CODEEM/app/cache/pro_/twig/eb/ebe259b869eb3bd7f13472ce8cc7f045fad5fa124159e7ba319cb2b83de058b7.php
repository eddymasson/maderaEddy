...
class __TwigTemplate_d3a29fd031ffa30f95422ffb7153f26a071594e7ca4cd16ce4be28d95600a51b extends Twig_Template
{
...
";
        // line 12
        if ((twig_get_attribute($this->env, $this->getSourceContext(), ($context["admin"] ?? null), "isGranted", array(0 => "VIEW", 1 => ($context["object"] ?? null)), "method") && twig_get_attribute($this->env, $this->getSourceContext(), ($context["admin"] ?? null), "hasRoute", array(0 => "show"), "method"))) {
            // line 13
            echo "    <a href=\"";
...
";
    ...
    {
        return new Twig_Source("", "SonataAdminBundle:CRUD:list__action_show.html.twig", "C:\\wamp\\www\\CODE\\vendor\\sonata-project\\admin-bundle/Resources/views/CRUD/list__action_show.html.twig");
    }
}
