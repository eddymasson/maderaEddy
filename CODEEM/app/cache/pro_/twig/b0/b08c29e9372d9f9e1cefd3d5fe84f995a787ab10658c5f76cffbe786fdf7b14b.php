...
class __TwigTemplate_954c3424278620afbd5329d75b98f5a1ccbec266240a110ac537ca98e21f94c6 extends Twig_Template
{
    ...
    {
        // line 12
        return $this->loadTemplate(twig_get_attribute($this->env, $this->getSourceContext(), twig_get_attribute($this->env, $this->getSourceContext(), ($context["sonata_block"] ?? null), "templates", array()), "block_base", array()), "@SonataAdmin/Block/block_search_result.html.twig", 12);
    }
...
($context["admin"] ?? null), "hasRoute", array(0 => "create"), "method") && twig_get_attribute($this->env, $this->getSourceContext(), ($context["admin"] ?? null), "isGranted", array(0 => "CREATE"), "method"))) {
            // line 28
            echo "                        <a href=\"";
...
";
    ...
    {
        return new Twig_Source("", "@SonataAdmin/Block/block_search_result.html.twig", "C:\\wamp\\www\\CODE\\vendor\\sonata-project\\admin-bundle\\Resources\\views\\Block\\block_search_result.html.twig");
    }
}
