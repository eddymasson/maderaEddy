...
class __TwigTemplate_11e02b4049f1e2684c5704a984e4a170f343b4d8859468b50becb48c73d5f6ad extends Twig_Template
{
    ...
    {
        // line 1
        return $this->loadTemplate(($context["base_template"] ?? null), "SonataUserBundle:Admin/Security/Resetting:reset.html.twig", 1);
    }
...
";
    ...
    public function block_sonata_user_reset_form($context, array $blocks = array())
    {
        ...
        echo "</p>
                <form action=\"";
        // line 27
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("sonata_user_admin_resetting_reset", array("token" => ($context["token"] ?? null))), "html", null, true);
        ...
        echo "\"/>
                    ...
                    ";
        // line 34
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\FormExtension')->renderer->searchAndRenderBlock(twig_get_attribute($this->env, $this->getSourceContext(), ($context["form"] ?? null), "_token", array()), 'widget');
        echo "
    ...
    {
        return new Twig_Source("", "SonataUserBundle:Admin/Security/Resetting:reset.html.twig", "C:\\wamp\\www\\CODE\\vendor\\sonata-project\\user-bundle/Resources/views/Admin/Security/Resetting/reset.html.twig");
    }
}
