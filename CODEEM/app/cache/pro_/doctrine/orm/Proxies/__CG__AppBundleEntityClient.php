...
class Client extends \AppBundle\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'nom', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'prenom', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'adresse', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'telephone', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'mail', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'idclient', '' . "\0" . 'AppBundle\\Entity\\Client' . "\0" . 'ville'];
        }
