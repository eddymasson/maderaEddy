 ...
 */
class Insee extends \AppBundle\Entity\Insee implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Insee' . "\0" . 'nomville', '' . "\0" . 'AppBundle\\Entity\\Insee' . "\0" . 'codepostal', '' . "\0" . 'AppBundle\\Entity\\Insee' . "\0" . 'idinsee'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Insee $proxy) {
    ...
    public function getIdinsee()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdinsee();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdinsee', []);

        return parent::getIdinsee();
    }
    ...
    public function setIdinsee($idinsee)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdinsee', [$idinsee]);

        return parent::setIdinsee($idinsee);
    }
