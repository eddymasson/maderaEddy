...
class Commande extends \AppBundle\Entity\Commande implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Commande' . "\0" . 'datecommande', '' . "\0" . 'AppBundle\\Entity\\Commande' . "\0" . 'vendeur', '' . "\0" . 'AppBundle\\Entity\\Commande' . "\0" . 'montant', '' . "\0" . 'AppBundle\\Entity\\Commande' . "\0" . 'idcommande', '' . "\0" . 'AppBundle\\Entity\\Commande' . "\0" . 'livraisonlivraison'];
        }
    ...
    public function setLivraisonlivraison(\AppBundle\Entity\Livraison $livraisonlivraison)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLivraisonlivraison', [$livraisonlivraison]);

        return parent::setLivraisonlivraison($livraisonlivraison);
    }
    ...
    public function getLivraisonlivraison()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLivraisonlivraison', []);

        return parent::getLivraisonlivraison();
    }
